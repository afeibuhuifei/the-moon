...
import { Clock, ZoomIn, Eye, Activity, GripVertical } from "lucide-react"
...
export function DraggableInfoPanel() {
	...
	return (
		<div
			ref={panelRef}
			className="fixed bg-black/40 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl p-4 min-w-[220px] select-none"
			style={{
				left: `${position.x}px`,
				top: `${position.y}px`,
